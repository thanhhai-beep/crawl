...
<head><link rel="canonical" href="https://androidppproxy-uae2-na61-pp.vip.tbsite.net/404">
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="//img.ucdl.pp.uc.cn/upload_files/pp_wap_ppcn/public/p/404.da4dfc2a.css">
</head>

<body><script>
with(document)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("exparams","category=&userid=&aplus&yunid=&&trid=2150460617344241812272584e9f55&asid=AQAAAAB1NmFnB6HmPwAAAAC2dFXbpPAj+A==",id="tb-beacon-aplus",src=(location>"https"?"//g":"//g")+".alicdn.com/alilog/mlog/aplus_v2.js")
</script>
...
<div id="pop-category" style="display: none">
    ...
    <ul class="nav">
        <li class="current" data-wach="header_cat_soft">软件分类</li>
        <li data-wach="header_cat_game">游戏分类</li>
    </ul>
    ...
    <p><img class="img-404" src="//img.ucdl.pp.uc.cn/upload_files/pp_wap_ppcn/other/404.png" alt="404" /></p>
    <p id="text-1">您迷路了，5 秒后带您回到起点~</p>
    <p><a href="https://wap.pp.cn/" class="go-index">我自己回去起点</a></p>
    
    
    
    <script type="text/javascript" src="//img.ucdl.pp.uc.cn/upload_files/pp_wap_ppcn/public/p/public.da4dfc2a.js"></script><script type="text/javascript" src="//img.ucdl.pp.uc.cn/upload_files/pp_wap_ppcn/public/p/pop-category.da4dfc2a.js"></script>
    <script type="text/javascript">
        ...
        t = setInterval(function() { 
            ...
            if(nSecond == 0) {
                clearInterval(t);
                window.location.href = "https://wap.pp.cn/";
            } else {
                document.getElementById("text-1").innerText = "您迷路了，" + nSecond + " 秒后带您回到起点~";
            }
        }, 1000);
    </script>
</body>
