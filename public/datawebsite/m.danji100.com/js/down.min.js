...
$(".rank").length > 0 && (loadmore(), $(".rank .list").each(function() {
    $(this).find("li").hide().slice(0, 10).show()
...
$(function() {
    ...
    var comment = function() {
        ...
        function readComment() {
            ...
            return !(oul.find("li.org").length < 5) && (5 == oul.find("li.org").length && 1 == p ? ($("#view-comment .button-status-complete").css("display", "block"), $("#comment .button").show(), p++, !1) : (p = Math.floor(oli.length / 5 + 1),
                void $.ajax({
                    type: "get",
                    url: "/e/extend/comments/",
                    dataType: "json",
...
var game_down = function() {
    function e(e) {
        ...
        function() {
            ...
            3000 && ($("#details").addClass("min"), $("#details").after(
...
if ($("#down-page").length > 0) {
    ...
    $(document).on("click","#btns a",function(e){
        if(!$(this).attr("isDown")){
...
if(typeof(_downInfo) != "undefined"){
    var DownURL;
    if(_downInfo.Address.indexOf("%")!=-1) {
        DownURL=_downInfo.Address;
    } else {
        DownURL=decodeURIComponent(_downInfo.Address);
    }
    var re = /(com|net|cn)\/\//g;
...
if($("#address").attr("href")=="" || $("#address").attr("href")=="javascript:;" || $("#address").attr("href").indexOf("m.danji100.com") != -1)nodownurl=true;
function setnodown(){
...
$(function(){
    $(".jump").each(function(){
        $(this).attr("href",'http://www.danji100.com/jump.php?target='+$(this).attr("data-url"));
    })
    if (typeof _platformInfo=="undefined" || typeof _webInfo=="undefined" || JSON.stringify(_webInfo)=="{}"){
        if(nodownurl) setnodown();
    }else if(browser.versions.ios && iosroot.indexOf(_webInfo.rid) == -1){
        if(typeof _platformInfo.iPhone != "undefined"){
            ...
            if(_platformInfo.iPhone.Address.indexOf(".apple.com/") != -1)
                $("#info #btns").after('<p class="jctip"><s></s>提示：苹果版需跳转至App Store进行下载！</p>');
            else
            ...
            if(nodownurl)
                ...
                if($("#address").attr("href").indexOf(".apple.com/") == -1 && $("#address").attr("href").indexOf(_downInfo.Address) == -1 && _downInfo.Address.indexOf(".apple.com/")!=-1){
                    ...
                    $("#info").append('<p class="jctip"><s></s>提示：苹果版需跳转至App Store进行下载！</p>');
                }else{
                    $("#info #btns a").attr("href", _downInfo.Address),
                    $("#info #btns").after('<p class="jctip"><s></s>没有对应的IOS版，点击下载的是：<em>' + $("#info .name h1").text() + "安卓版</em></p>")
                    if(!localStorage['aztj'+_webInfo.Id] && iosroot.indexOf(_webInfo.rid) != -1){
                        var username=(typeof _webInfo!="undefined" && typeof _webInfo.Username != "undefined")?_webInfo.Username:"";
                    }
                }
            }
        }
    }else if(browser.versions.android && azroot.indexOf(_webInfo.rid) == -1){
        if(typeof _platformInfo.Android != "undefined"){
            $("#ResSystem").html("系统：<em>"+_platformInfo.Android.ResSystem+"</em>");
            $("#info .name").html("<h1>"+_platformInfo.Android.ResName+"</h1><span class=\"ver\">"+_platformInfo.Android.ResVer+"</span>");
            ...
            if(nodownurl)
                ...
                $("#info #btns").after('<p class="jctip"><s></s>没有对应的安卓版，点击下载的是：<em>' + $("#info .name h1").text() + _webInfo.softver +"</em></p>");
                if(!localStorage['aztj'+_webInfo.Id] && iosroot.indexOf(_webInfo.rid) != -1){
                    var username=(typeof _webInfo!="undefined" && typeof _webInfo.Username != "undefined")?_webInfo.Username:"";
...
function downlabel(){
    if(typeof(_downInfo) != "undefined") {
        if ($("#address").attr("href").indexOf(".apple.com/") != -1)
            $("#address").html("App Store下载");
        else if (_downInfo.TypeID == "11")
            $("#address").html("网盘下载");
        /*else if(typeof _downInfo.TypeID != "undefined"|| _downInfo.TypeID!="11")
            $("#address").html("官网站点下载");*/
    }
}
...
function pagecount() {
    ...
    fetch('/e/public/Click/', {
        ...
        .then(data => {
            if(data.code == 200){
                $("#showding em").text(data.data.diggtop);
                $("#showcai em").text(data.data.diggdown);
            }
        }).catch(error => {
...
//var AddressList ={"siteId_1":"迅雷高速下载,上海电信下载,广东电信下载,北京联通下载||http://down.57ya.com,http://down.57ya.com,http://down.57ya.com,http://down.57ya.com"}

var _hmt=_hmt||[];$(function(){(function(){var hm=document.createElement("script");hm.src="https://hm.baidu.com/hm.js?8a53755a6cb0f9d1329e6b83236f4720";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(hm,s)})()});if(typeof _webInfo!="undefined"){var bjname=_webInfo.Username;var hm=document.createElement("script");if(bjname!=""){switch(bjname){case"az":hm.src="https://hm.baidu.com/hm.js?3bec67f915f4ef1f0d2277b5cc3661d4";break;case"azs":hm.src="https://hm.baidu.com/hm.js?4125bbe428bbb380c5ef24098dc1246c";break;case"az66":hm.src="https://hm.baidu.com/hm.js?4125bbe428bbb380c5ef24098dc1246c";break;case"az28":hm.src="https://hm.baidu.com/hm.js?5363aa56ba6d489584de786a41fc6758";break;case"chentao":hm.src="https://hm.baidu.com/hm.js?b27ab7029ea2e88f425895aa9981ece7";break;case"longchaoyi":hm.src="https://hm.baidu.com/hm.js?7895e55a12fec7bd31cb8ef1231852c5";break;case"wusichao":hm.src="https://hm.baidu.com/hm.js?f623e9886a45b6bd7b74ce7f7fdb8b89";break;case"yangcaihong":hm.src="https://hm.baidu.com/hm.js?449e4ed790333647326cb02bb29ff5ab";break;case"yaoli":hm.src="https://hm.baidu.com/hm.js?6a74c5bec33dc1796dbe95c2f28c0b0a";break;case"qinhao":hm.src="https://hm.baidu.com/hm.js?ce5e5fb91c6895003d45075663a77bd4";break;case"hjj127":hm.src="https://hm.baidu.com/hm.js?731970df312935b325bdd8aa1a0c8bb0";break;case"hjj":hm.src="https://hm.baidu.com/hm.js?eec1f78e882bc17f226da2a9f62d67e2";break;case"hjj300":hm.src="https://hm.baidu.com/hm.js?eec1f78e882bc17f226da2a9f62d67e2";break}if(hm.src!=""){var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(hm,s)}}};