...
(function (global, factory) {
  ...
  var TEMPLATE = '<div class="viewer-container" touch-action="none">' + '<div class="viewer-canvas"></div>' +
  '<div class="viewer-toolbar-nav"></div>' + '<div class="viewer-footer">' +
  '<div class="viewer-title"></div>' + '<div class="viewer-toolbar"></div>' +
  '<div class="viewer-navbar">' + '<ul class="viewer-list"></ul>' + '</div>' + '</div>' +
  ...
  function () {
    ...
    _createClass(Viewer, [{
      ...
      value: function build() {
        ...
        var toolbarNav = viewer.querySelector(".".concat(NAMESPACE, "-toolbar-nav"));
        ...
        if (options.toolbar) {
          ...
          // 左右切换按钮
          var prevNextButtons = [BUTTONS[4], BUTTONS[6]];
          var navList = document.createElement('div');
          navList.className = "".concat(NAMESPACE, "-toolbar-nav-inner");
          forEach(prevNextButtons, function (value, index) {
              var item = document.createElement('span');
              item.setAttribute('role', 'button');
              addClass(item, "".concat(NAMESPACE, "-").concat(value));
              setData(item, DATA_ACTION, value);
              navList.appendChild(item);
          });
          toolbarNav.appendChild(navList);
        } else {
