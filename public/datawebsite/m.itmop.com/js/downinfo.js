...
var iosroot=["13", "16"];
var azroot=["11", "12", "15"];
if($("#address").attr("href")=="" || $("#address").attr("href")=="javascript:;" || $("#address").attr("href").indexOf("m.itmop.com") != -1)nodownurl=true;
function setnodown(){
...
function iswangpan(){
	if(typeof _downInfo != "undefined" && typeof _downInfo.TypeID != "undefined"&&_downInfo.TypeID=="-3")return true;
...
$(function(){
	...
	if(typeof(_pageinfo) != "undefined"){
		if(typeof(_pageinfo.softlicence) != 'undefined'){
			if(_pageinfo.softlicence == "\u4e0b\u67b6")closePage("#nav",".bottom");
		}
	}
...
var game_down = function() {
	...
	function() {
		...
		if($(".xgxz li").length>0)	$("#tab span:first").after("<span>相关推荐</span>");
		if($("#tcsyy li").length>0)	$("#tab span:last").before("<span>相同厂商</span>");

		$("#tab span").click(function() {
			"游戏介绍" == $(this).text() || "软件介绍" == $(this).text()  || "介绍" == $(this).text() || "简介" == $(this).text() ? ($(this).addClass("cur").siblings().removeClass("cur"), $(".xyc,.cont,#comment,.xgwz,.similar,#tcsyy,.xgxz,.guess,#xgk,.tips_more,.h5online,.hot_gamerec,.rank,.rela_down").show()) : "文章" == $(this).text() ? ($(this).addClass("cur").siblings().removeClass("cur"), $(".cont,.xyc,.similar,#tcsyy,.xgxz,#xgk,.guess,.tips_more,.h5online,.hot_gamerec,.rank,#comment,.rela_down").hide(), $(".xgwz").show()) : $(this).text().indexOf("评论") > -1 && ($(this).addClass("cur").siblings().removeClass("cur"), $(".xgwz,.cont,.xyc,.similar,#tcsyy,.xgxz,#xgk,.guess,.tips_more,.h5online,.hot_gamerec,.rank,.rela_down").hide(), $("#comment").show());

			"相关推荐" == $(this).text() && ($(this).addClass("cur").siblings().removeClass("cur"), $(".xgwz,.cont,.xyc,.similar,#tcsyy,#xgk,.guess,.tips_more,.h5online,.hot_gamerec,.rank,.rela_down,.compy,.historyver,.xgxz,.qx,#comment").hide(), $(".xgxz,.rela_down").show(),tt=$("html,body").scrollTop(),$("html,body").scrollTop(tt+1),$("html,body").scrollTop(tt));
			"相同厂商" == $(this).text() && ($(this).addClass("cur").siblings().removeClass("cur"), $(".xgwz,.cont,.xyc,.similar,#tcsyy,#xgk,.guess,.tips_more,.h5online,.hot_gamerec,.rank,.rela_down,.compy,.historyver,.xgxz,.qx,#comment").hide(), $("#tcsyy,.xgxz,.rela_down").show());
		})
	} (),
	function() {
...
function showgaosu(result) {
    ...
    if(/android/i.test(navigator.userAgent)){
		...
		function addaq(){
            ...
            $("#address").css({color:"#65bb0a",background:"#fff",border:"1px solid #65bb0a"});
...
["官居一品","http://www.danji100.com/game/550.html","http://pic.danji100.com/upload/2018-5/2018581719481979.png"]],
	//苹果弹层
	tcIosData:[["阿拉德之怒","http://m.itmop.com/downinfo/212053.html","http://img.itmop.com/upload/2017-10/20171081056343276.png"],
 ["天龙八部","http://m.itmop.com/downinfo/156925.html","http://img.itmop.com/upload/2017-5/201756957216885.png"],
["全民枪战2","http://m.itmop.com/downinfo/223.html","http://img.itmop.com/upload/2017-11/201711151745314662.jpg"],
["口袋妖怪复刻","http://m.itmop.com/downinfo/65114.html","http://img.itmop.com/upload/2016-8/20168101141212209.jpg"],
["火影忍者忍者大师","http://m.itmop.com/downinfo/156891.html","http://img.itmop.com/upload/2017-5/201756919502150.png"],
["妖怪金手指","http://m.itmop.com/downinfo/106645.html","http://img.itmop.com/upload/2018-2/2018281032306433.jpg"],
